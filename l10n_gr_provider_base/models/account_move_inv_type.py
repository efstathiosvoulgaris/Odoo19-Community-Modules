...
EXTRA_TYPES_WITH_VAT_CATEGORY_8 = ('8.4', '8.5', '8.6', '9.3')
...
# 9.3: dispatch note, no classifications at all → empty dict.
...
CLASSIFICATION_MAP.setdefault('9.3', {})
    ...
    def _compute_l10n_gr_edi_available_inv_type(self):
        ...
        for move in self:
            if move.is_sale_document(include_receipts=True) and move.l10n_gr_edi_available_inv_type:
                extras = ','.join(EXTRA_TYPES_WITH_INCOME + ('9.3',))
