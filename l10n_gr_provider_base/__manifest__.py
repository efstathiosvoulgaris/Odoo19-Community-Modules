# -*- coding: utf-8 -*-
{
    ...
    'description': (
        ...
        'Changelog\n'
        '---------\n'
        '2.10 — Ο αριθμός της οδού διαβιβάζεται πλέον ξεχωριστά. Το BT-36 και\n'
        'οι διευθύνσεις φόρτωσης/παράδοσης των δελτίων διακίνησης απαιτούν\n'
        'χωριστό «αριθμό» (MDP-0024 / MDP-0026), αλλά η Odoo δεν έχει τέτοιο\n'
        'πεδίο, οπότε το «Γεωργαντά 22» έμενε ολόκληρο στην οδό και ο αριθμός\n'
        'έφευγε κενός. Χρησιμοποιείται το «Αριθμός» (arithmos_odou) ή το\n'
        'street2, αλλιώς αποσπάται ο αριθμός από το τέλος της οδού. Δελτίο\n'
        'διακίνησης με ελλιπή διεύθυνση μπλοκάρεται πριν την αποστολή.\n'
        '\n'
        'Το κουμπί τακτοποίησης ενεργοποιεί πλέον και τις μονάδες\n'
        'μέτρησης της ΑΑΔΕ, εκτός από τη σήμανση με τον κωδικό §8.13: η Odoo\n'
        'έρχεται με τα m³ αρχειοθετημένα, οπότε τα «Κυβικά Μέτρα» είχαν κωδικό\n'
        'αλλά δεν επιλέγονταν. Αναφέρει επίσης πόσες ενεργές μονάδες δεν έχουν\n'
        'κωδικό — αυτές φεύγουν ως 7 (Λοιπές Περιπτώσεις) με το όνομά τους —\n'
        'και αρχειοθετεί όσες από αυτές δεν χρησιμοποιούνται πουθενά. Οι\n'
        'βασικές μονάδες g, ml, mm εξαιρούνται αυτόματα: πάνω τους στηρίζονται\n'
        'τα kg, L, m. Αναστρέψιμο από το φίλτρο «Archived».\n'
        '\n'
        'Ημερολόγιο χωρίς τύπο myDATA είναι πλέον καθαρά λογιστικό: το\n'
        'παραστατικό δεν μπαίνει σε ουρά αποστολής, δεν έχει κουμπί αποστολής\n'
        'και δεν το πιάνει το cron. Μέχρι τώρα ένα τιμολόγιο στο «Πωλήσεις»\n'
        '(ΠΩΛ) — το ημερολόγιο για παλιά τιμολόγια που καταχωρούνται μόνο για\n'
        'αρχείο — διαβιβαζόταν στην ΑΑΔΕ ως 1.1, τύπος που συμπληρώνει μόνη\n'
        'της η βασική l10n_gr_edi.\n'
        '\n'
        'Αφαιρέθηκε ο επιλογέας «Invoice Type» από τη φόρμα του\n'
        'παραστατικού: ο τύπος myDATA καθορίζεται από το ημερολόγιο, όπως και\n'
        'η αρίθμηση, η φόρμα εκτύπωσης και οι επιτρεπτοί φόροι. Εμφανιζόταν\n'
        'μόνο σε ημερολόγιο χωρίς τύπο (το «Πωλήσεις»/ΠΩΛ του λογιστικού\n'
        'σχεδίου), όπου η αλλαγή του δεν επηρέαζε τίποτε άλλο.\n'
        '\n'
        'Η μονάδα μέτρησης της γραμμής διαβιβάζεται πλέον σωστά και\n'
        'στο EN16931 σκέλος (invoicedQuantityUnits / BT-130): έβγαινε πάντα\n'
        '«EA» (τεμάχια), οπότε μια γραμμή σε κιλά δήλωνε στην ΑΑΔΕ κωδικό 2\n'
        '(Κιλά) και στον αγοραστή «τεμάχια». Ο κωδικός UN/ECE Rec 20 προκύπτει\n'
        'πλέον από τον ίδιο κωδικό §8.13, οπότε δεν μπορούν να διαφωνήσουν.\n'
        '\n'
