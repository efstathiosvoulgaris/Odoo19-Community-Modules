# -*- coding: utf-8 -*-
{
    ...
    'description': (
        ...
        'Methods declared as type 8 (IRIS direct) are left out of the signature\n'
        'flow — an open question with ILYDA, not a settled reading: the myDATA\n'
        '2.0.1 XSD allows a provider signature on any payment type and names\n'
        'EndToEndReferenceID «για πληρωμές IRIS». See README.\n'
        '\n'
