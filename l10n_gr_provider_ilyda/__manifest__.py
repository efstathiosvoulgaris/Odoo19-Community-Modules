# -*- coding: utf-8 -*-
{
    ...
    'description': (
        ...
        'Changelog\n'
        '---------\n'
        '2.6 — Η διεύθυνση του πωλητή και οι διευθύνσεις φόρτωσης/παράδοσης\n'
        'στέλνονται με χωριστό αριθμό οδού (MDP-0024 / MDP-0026). Δελτίο\n'
        'διακίνησης με ελλιπή διεύθυνση μπλοκάρεται πριν την αποστολή, με\n'
        'μήνυμα που ονομάζει την επαφή και τα πεδία που λείπουν.\n'
        '\n'
        '2.5 — Η μονάδα μέτρησης της γραμμής φεύγει πλέον σωστά και στο\n'
        'EN16931 σκέλος (invoicedQuantityUnits): έβγαινε πάντα «EA». Επίσης,\n'
        'γραμμή με ποσότητα <= 0 σε παραστατικό που διαβιβάζει ποσότητες\n'
        '(διακίνηση, δελτίο αποστολής, 8.6) μπλοκάρεται πριν την αποστολή —\n'
        'το XSD απαιτεί ποσότητα > 0 και η ΑΑΔΕ απορρίπτει όλο το παραστατικό\n'
        'χωρίς να αναφέρει ποια γραμμή φταίει.\n'
        '\n'
